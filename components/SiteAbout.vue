<template>
    <section class="site site-about">
        <div class="container site-about-content">
            <h1>I’m <a @click="popup($event)" href="#" id="action-link">Tristan</a>, a front-end developer using motion to tell <nuxt-link to="/projecs">engaging stories</nuxt-link> for brands.</h1>
